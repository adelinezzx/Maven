...
public class TestMybatis {
	...
	public void testOneCity() {
		...
		try {
			session = factory.openSession();
	    	City  result =  session.selectOne( "com.yc.dao.mapper.cityMapper.selectOneCity", 1);
	...
	@Test
	public void testselectOneProvince() {
		SqlSession session = null ;
		try {
			session = factory.openSession();
	    	Province  result =  session.selectOne( "com.yc.dao.mapper.provinceMapper.selectOneProvince", 1);
			 System.out.println(result);
		} catch (Exception e) {
			e.printStackTrace();
		}finally {
